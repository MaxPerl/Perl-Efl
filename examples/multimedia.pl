...
sub _player_info_cb {
	...
	# set the file label
	my $flabel = Efl::Elm::Label->add($table);
	...
	my $fnlabel = Efl::Elm::Label->add($table);
	...
	my $dlabel = Efl::Elm::Label->add($table);
	$dlabel->text_set("Size: ");
	$dlabel->show();
	$table->pack($dlabel, 0,4,1,1);
	
	my $dimlabel = Efl::Elm::Label->add($table);
