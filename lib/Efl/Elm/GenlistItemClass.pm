package Efl::Elm::GenlistItemClass;
...
require XSLoader;
XSLoader::load('Efl::Elm::GenlistItemClass');
...
sub text_get {
    ...
    Efl::PLSide::gen_text_get($obj,$func);
...
sub state_get {
    ...
    Efl::PLSide::gen_state_get($obj,$func);
...
For instructions, how to use Efl::Elm::GenlistItemClass, please study this API reference for now. A perl-specific documentation will perhaps come in later versions. But applying the C documentation should be no problem. Efl::Elm::GenlistItemClass gives you a nice object-oriented interface that is kept close to the C API. Please note, that the perl method names remove the "elm_genlist_item_class_" at the beginning of the c functions.
