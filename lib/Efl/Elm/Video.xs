...
// We need this typedef to bless the created object into the class ElmVideoPtr
// This class is a child class of Efl::Elm::Video, which inherits from EvasObjectPtr
// see the @ISA's in Elm/Video.pm
...
MODULE = Efl::Elm::Video		PACKAGE = ElmVideoPtr     PREFIX = elm_video_
