...
MODULE = Efl::Elm::Config		PACKAGE = Efl::Elm::Config	PREFIX = elm_config_
...
MODULE = Efl::Elm::Config		PACKAGE = ElmTextClassPtr
...
MODULE = Efl::Elm::Config		PACKAGE = ElmFontOverlayPtr
...
MODULE = Efl::Elm::Config		PACKAGE = ElmColorClassPtr
