...
// We need this typedef to bless the created object into the class ElmLayoutPtr
// This class is a child class of Efl::Elm::Layout, which inherits from EvasObjectPtr
// see the @ISA's in Elm/Layout.pm
// By this trick we get a wonderful perlish oo-interface :-)
typedef Evas_Object ElmLayout;
typedef Evas_Object EvasObject;
typedef Eina_List EinaList;

MODULE = Efl::Elm::Layout		PACKAGE = Efl::Elm::Layout

ElmLayout *
elm_layout_add(parent)
	EvasObject *parent

MODULE = Efl::Elm::Layout		PACKAGE = ElmLayoutPtr     PREFIX = elm_layout_
