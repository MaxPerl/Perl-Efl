...
MODULE = Efl::Elm::Table		PACKAGE = Efl::Elm::Table

ElmTable * 
elm_table_add(EvasObject *parent)

MODULE = Efl::Elm::Table		PACKAGE = Efl::Elm::Table     PREFIX = elm_table_
...
MODULE = Efl::Elm::Table		PACKAGE = ElmTablePtr     PREFIX = elm_table_
