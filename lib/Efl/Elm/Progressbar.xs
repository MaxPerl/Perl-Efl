...
MODULE = Efl::Elm::Progressbar		PACKAGE = Efl::Elm::Progressbar

ElmProgressbar *
elm_progressbar_add(parent)
    EvasObject *parent

MODULE = Efl::Elm::Progressbar		PACKAGE = ElmProgressbarPtr     PREFIX = elm_progressbar_
...
void
_elm_progressbar_unit_format_function_set(obj,func,pobj)
	ElmProgressbar *obj
	SV* func
	SV* pobj
PREINIT:
