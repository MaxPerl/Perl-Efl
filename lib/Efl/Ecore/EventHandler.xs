...
MODULE = Efl::Ecore::EventHandler		PACKAGE = Efl::Ecore::EventHandler   PREFIX = ecore_event_handler_
...
MODULE = Efl::Ecore::EventHandler		PACKAGE = EcoreEventHandlerPtr   PREFIX = ecore_event_handler_
...
CODE:
	...
	id = (intptr_t) data;
	AV *Cbs_data = get_av("Efl::PLSide::EcoreEventHandler_Cbs", 0);
